...
class BookningModal extends Component {
                        ...
                        <div className='booking-modal-body'>
                            ...
                            <div className='row'>
                                ...
                                <div className='col-6 form-group'>
                                    ...
                                    <DataPicker className='form-control' value={this.state.birthday} onChange={this.handleOnchangeDatePicker} />
                                </div>
                                <div className='col-6 form-group'>
                                    <label><FormattedMessage id='patient.booking-modal.gender' /></label>
                                    <Select className='h-s' value={this.state.selectedGender} options={this.state.genders} onChange={this.handleOnchangeSelect} />
                                </div>
                            </div>
                        </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(BookningModal);
