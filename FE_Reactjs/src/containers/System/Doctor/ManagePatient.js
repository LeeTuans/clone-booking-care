        ...
        return (
            <>
                <LoadingOverlay active={this.state.isShowLoading} spinner text="Loading...">
                                            ...
                                            dataPatient.map((item, index) => {
                                                ...
                                                return (
                                                    <tr key={index}>
                                                        ...
                                                        <td>{gender}</td>
                                                        <td>
                                                            <button className='btn btn-success' onClick={() => this.handleBtnConfirm(item)}>Xác nhận</button>
                                                        </td>
                                                    </tr>
                                                )
                                            })
                    ...
                    <RemedyModal isOpenModal={isOpenRemedyModal} dataModal={dataModal}
                        closeRemedyModal={this.closeRemedyModal} sendRemedy={this.sendRemedy} />
                </LoadingOverlay>
            </>
        )
    }
