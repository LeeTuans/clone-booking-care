                        ...
                        <div className='short-infor'>
                            ...
                            <b>
                                {extraInfor && extraInfor.priceTypeData && language === LANGUAGES.VI &&
                                    <NumericFormat className='currency' displayType="text" value={extraInfor.priceTypeData.valueVI}
                                        thousandSeparator={true} suffix={' VNĐ'} />
                                }
                                {extraInfor && extraInfor.priceTypeData && language === LANGUAGES.EN &&
                                    <NumericFormat className='currency' displayType="text" value={extraInfor.priceTypeData.valueEN}
